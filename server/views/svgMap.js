  ...
  svgMap.prototype.getTooltipContent = function (countryID) {
    ...
    if (this.options.hideFlag === false) {
      ...
      if (this.options.flagType === 'image') {
        ...
        //mycode
        this.createElement('img', 'svgMap-tooltip-food', foodContainer)
            .setAttribute('src',this.options.foodURL.replace('{0}',countryID.toLowerCase()));
...
/*
  const Searching = Search.prototypes;
  ...
  Searching.Engine = function(){
    this.form.addEventListener('submit',function(e) {
      ...
      connection.query("SELECT * FROM fooooder.food where country like ('"+keyword+"%')", function(err, result,fields){
        if(err) throw err;
        console.log(result);
    })  
    })
